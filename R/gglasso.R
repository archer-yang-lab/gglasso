				...
				eps=1e-8, maxit=3e8, delta)
{
	...
	# call Fortran core
	 fit=switch(loss,
		ls = ls(bn,bs,ix,iy,gamma,nobs,nvars,x,y,pf,dfmax,pmax,nlam,flmin,ulam,eps,maxit,vnames,group),
		logit = logit(bn,bs,ix,iy,gamma,nobs,nvars,x,y,pf,dfmax,pmax,nlam,flmin,ulam,eps,maxit,vnames,group),
		sqsvm = sqsvm(bn,bs,ix,iy,gamma,nobs,nvars,x,y,pf,dfmax,pmax,nlam,flmin,ulam,eps,maxit,vnames,group),
		hsvm = hsvm(delta,bn,bs,ix,iy,gamma,nobs,nvars,x,y,pf,dfmax,pmax,nlam,flmin,ulam,eps,maxit,vnames,group))
	#################################################################################	
	# output	
