! --------------------------------------------------
subroutine bexplasso (w,bn,bs,ix,iy,maj,nobs,nvars,x,y,pf,dfmax,pmax,nlam,flmin,ulam,&
...
! - - - local declarations - - -                    
    double precision :: d,t,dif,unorm,al,alf
 	double precision, dimension (:), allocatable :: b,oldbeta,r,oldb,u,dd,num,dl
...
!---------- final update variable and save results------------                             	                                             
		...
		if(me>dfmax) exit                                                                                                           
	enddo    
	deallocate(b,oldbeta,r,dl,oidx,num)                                         
	return                                                               
end subroutine bexplasso